...
export default function EmployeeDetailsModal({ open, onClose, userDetails }) {
  ...
  const singleEmployeeQuery = useGetEmployeeRevenueById(userDetails?.id);
                  ...
                  <div className="flex flex-col justify-around h-full w-full text-center">
                    ...
                    <Typography className="text-2xl mt-2 text-white" variant="overline">
                      <span className="text-2xl">
                        ₹ {fShortenNumber(singleEmployeeQuery?.data || 0)}
                      </span>
                    </Typography>
                  </div>
                </Grid>
